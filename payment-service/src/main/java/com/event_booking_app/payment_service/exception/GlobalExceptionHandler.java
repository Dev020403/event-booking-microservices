...
import com.event_booking_app.payment_service.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handlePaymentNotFound(
        ...
        log.warn("Payment not found [path={}]: {}", request.getRequestURI(), ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleUnsupportedPaymentMethod(
            UnsupportedPaymentMethodException ex, HttpServletRequest request) {
        log.warn("Unsupported payment method [path={}]: {}", request.getRequestURI(), ex.getMessage());
        ErrorResponse errorResponse = ErrorResponse.of(
    ...
    public ResponseEntity<ErrorResponse> handlePaymentProcessing(
        ...
        log.error("Payment processing error [path={}]: {}", request.getRequestURI(), ex.getMessage());
        ErrorResponse errorResponse = ErrorResponse.of(
